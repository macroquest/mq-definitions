...
--- @field public ActiveDisc any Returns a spell if melee discipline is active.
...
--- @field public AltAbility any Returns the total number of points you have spent in ability # or name
...
--- @field public AggroLock any spawn info for aggro lock player
...
--- @field public Bank any Item in this bankslot #
...
--- @field public Buff any The buff with this name
...
--- @field public Corrupted any Returns the name of the Corrupted debuff if you have one
...
--- @field public Cursed any Returns the name of the Curse debuff if you are effected by one
...
--- @field public Downtime any Downtime (Ticks left til combat timer end)
...
--- @field public Fellowship any Info about Fellowship
...
--- @field public GemTimer any The timer for the spell with this name or in this gem #
--- @field public Gold number Gold on character
--- @field public GoldBank number Gold in bank
--- @field public GroupAssistTarget any Current group assist target
...
--- @field public GroupMarkNPC any Current group marked NPC (1-3)
...
--- @field public Inventory any Item in this slot #
...
--- @field public LastZoned any Returns a timestamp of last time you zoned
...
--- @field public PctAAExp any AA exp as a %
...
--- @field public PctExp any Experience as a %
--- @field public PctGroupLeaderExp any Group leadership exp as a %
--- @field public PctHPs number Current HP as a %
--- @field public PctMana number Current mana as a %
--- @field public PctRaidLeaderExp any Raid leadership experience as a %
--- @field public PctVitality number Percentage of Vitality the toon has
--- @field public PetBuff any The spell in this PetBuff slot #
...
--- @field public RaidAssistTarget any Current raid assist target (1-3)
...
--- @field public RaidMarkNPC any Current raid marked NPC (1-3)
...
--- @field public SecondaryAggroPlayer any spawninfo for secondary aggro player
...
--- @field public Sit any Causes toon to sit if not already
...
--- @field public Song any Finds song with this name
--- @field public Spawn any The character's spawn
...
--- @field public Stand any causes toon to stand if not already
--- @field public StopCast any Causes toon to stop casting
...
--- @field public TargetOfTarget any Target of Target (will only work when group or raid Target of Target is active; if not, it will return NULL)
...
--- @field public TributeTimer any Tribute Timer
--- @field public UseAdvancedLooting boolean TRUE/FALSE if using advanced looting
--- @field public WIS number Character Wisdom
--- @field public XTarget any Extended target data for the specified XTarget #. Note: Passing no index to this returns the number of current extended targets.
