...
---@field public Item fun(index:integer): bandolieritem Provides information about the specified item. Returns the Nth item in the set (Primary, Secondary, Ranged, Ammo)
