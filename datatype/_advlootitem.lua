...
---@field public IconID fun(): integer	The ID of the icon for the item.
---@field public ID fun(): integer The ID of the item.
---@field public Index fun(): integer The positional index of the item.
...
---@field public StackSize fun(): integer	The size of the stack of items being looted.