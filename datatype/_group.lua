--- @class group
--- @field public AnyoneMissing fun(): boolean TRUE if someone is missing in group, offline, in other zone or simply just dead
--- @field public CasterMercCount fun(): number count of how many Caster DPS mercenaries are in your group
...
--- @field public Offline fun(): boolean will return a TRUE if offline, and FALSE if online
--- @field public OtherZone fun(): boolean will return a Bool TRUE if online but in another zone and FALSE if online and in same zone as you.
